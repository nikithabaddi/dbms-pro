...
<body>
    <section class="sub-header">
     <nav>
       <a href="main.html"><img src="crudecrew.png" ></a>
...
<section class="  booking ">
    <div class="row">
        ...
        <div class="forms"> 
              <div><h3> UPDATE BOOKING DETAILS <a>NOW</a></h3></div>  
               
               <form class="comment-form" method="POST">
                                    
                   <input type="text" value="<?php echo $result['name']?>"placeholder="Enter Name" name="name">

                   <select id="dropdown" type="text" value="<?php echo $result['Payment_method'] ?>"placeholder="Payment Method" name="Payment_method">
                    ...
                    <input type="email" value="<?php echo $result['email']?>"placeholder="Enter Email" name="email">

                   
                    
                    <input type="number" value="<?php echo $result['number'] ?>"placeholder=" Enter Phone number" name="number">
                    ...
                    <input type="text" value="<?php echo $result['brand']?>"placeholder=" Enter Vehicle brand" name="brand">
                    ...
                    <option value="text" disabled selected value >Select Service</option>
                    <option value="Engine oil change and oil filter change"
                    <?php
                          if($result['service']=='Engine oil change and oil filter change')
                          {
                            echo "selected";
                          }
                    ?>
                    >Engine oil change and oil filter change</option>
                    <option value="Gear box oil change"
                    <?php
                          if($result['service']=='Gear box oil change')
                          {
                            echo "selected";
                          }
                    ?>
                    >Gear box oil change</option>
                    <option value="Housing(differential) oil change"
                    <?php
                          if($result['service']=='Housing(differential) oil change')
                          {
                            echo "selected";
                          }
                    ?>
                    >Housing(differential) oil change</option>
                    <option value="Power steering oil change or /top-up"
                    <?php
                          if($result['service']=='Power steering oil change or /top-up')
                          {
                            echo "selected";
                          }
                    ?>
                    >Power steering oil change or /top-up</option>
                    <option value="Fuel filter change"
                    <?php
                          if($result['service']=='Fuel filter change')
                          {
                            echo "selected";
                          }
                    ?>
                    >Fuel filter change</option>
                    <option value="Break fluid /top-up"
                    <?php
                          if($result['service']=='Break fluid /top-up')
                          {
                            echo "selected";
                          }
                    ?>
                    >Break fluid /top-up</option>
                    <option value="Air filter change or cleaning"
                    <?php
                          if($result['service']=='Air filter change or cleaning')
                          {
                            echo "selected";
                          }
                    ?>
                    >Air filter change or cleaning</option>
                    <option value="Hydraulic oil change">Hydraulic oil change</option>
                   
                    <input type="number" value="<?php echo $result['vehicle_number']?>"placeholder="Enter Vehicle number" name="vehicle_number">
                    
                    <select id="dropdown" type="text" value="<?php echo $result['oil_type']?>" placeholder=" Select Oil Brand" name="oil_type">
                        <option value="Select Oil Brand" >Select Oil Brand</option>
                       <option value="Castrol"
                       <?php
                          if($result['oil_type']=='Castrol')
                          {
                            echo "selected";
                          }
                    ?>
                    ...
                    ?>
                     ...
                     <input type="date" value="<?php echo $result['date'] ?>"placeholder="Select Appointment date " name=" date" >
                      
                       <button type="update" class="hero-btn red-btn" name="update" > update</button><br>
...
<?php
$name= $email= $number = $type =$brand =$service =$vehicle_number =$oil_type =$date =$Payment_method=$cin=$cout='';
...
$query="UPDATE booking set name='$name',email='$email',number='$number', type='$type',brand='$brand', service='$service', vehicle_number='$vehicle_number', oil_type='$oil_type', date='$date', Payment_method='$Payment_method' WHERE ID=$id
";
